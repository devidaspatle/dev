                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="index.php" class="logo-image"><img src="assets/img/logo/logo-white.png" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <ul>
                                                    ...
                                                    <div class="cart__inner d-flex">
                                                      ...
                                                      <div class="cart__details">
                                                        ...
                                                        <div class="cart__price">
                                                          <span><i class="fa fa-rupee" style="font-size:24px"></i>255.00</span>
                                                        </div>
                                                      </div>
                                                    </div>
                                                    <div class="cart__del">
                                                ...
                                                <li>
                                                  <div class="cart__sub d-flex justify-content-between align-items-center">
                                                    <h6>Subtotal</h6>
                                                    <span class="cart__sub-total"><i class="fa fa-rupee" style="font-size:24px"></i>255.00</span>
                                                  </div>
                                                </li>
                                                <li>
                ...
                <div class="row g-0 align-items-center">
                    <div class="col-lg-3">                        
                        <div class="cat__menu-wrapper side-border d-none d-lg-block">
                            <div class="cat-toggle">
                                <button type="button" class="cat-toggle-btn cat-toggle-btn-1"><i class="fal fa-bars"></i> Menu</button>
                                <div class="cat__menu">
                                    <nav id="mobile-menu" style="display: none;">
                                        <ul>
                                            ...
                                            <li><a href="winner-list-month.php">Winner List Month wise</a></li>
                                           
                                           <!-- <li><a href="blog.html">Winner <i class="far fa-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="blog.html">Winner List</a></li>
                                                    <li><a href="blog-details.html">Month wise</a></li>
                                                </ul>
                                            </li>-->
                                            <li>
                    ...
                    <div class="col-lg-3 col-md-6 col-9">
                        <div class="shopeing-text text-sm-end">
                            <p>Buy any Product & Get Assured gift!</p>
                        </div>
                    </div>
                </div>
            </div>
